...
use crate::{
    ...
    unitdef::UnitDefinition, upcast_annotation,
};
...
impl<'a> Unit<'a> {
    ...
    required_property!(Unit<'a>, kind, UnitKind, getKind, setKind);

    // Getter and setter for exponent
    required_property!(Unit<'a>, exponent, i32, getExponent, setExponent);

    // Getter and setter for multiplier
    required_property!(Unit<'a>, multiplier, f64, getMultiplier, setMultiplier);

    // Getter and setter for scale
    required_property!(Unit<'a>, scale, i32, getScale, setScale);

    // Getter and setter for offset
    required_property!(Unit<'a>, offset, f64, getOffset, setOffset);

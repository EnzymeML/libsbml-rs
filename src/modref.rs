...
use crate::{
    clone, inner, pin_ptr, prelude::IntoId, reaction::Reaction, sbase, sbmlcxx, sbo_term,
    traits::fromptr::FromPtr, upcast, upcast_annotation, upcast_pin, upcast_required_property,
};
...
impl<'a> ModifierSpeciesReference<'a> {
    ...
    // Getter and setter methods for the species property
...
/// Implementation of the FromPtr trait for the ModifierSpeciesReference type
///
/// This implementation allows the ModifierSpeciesReference type to be created from a raw pointer to a libSBML ModifierSpeciesReference.
...
impl<'a> ModifierSpeciesReferenceBuilder<'a> {
    ...
    pub fn new(reaction: &Reaction<'a>, sid: impl IntoId) -> Self {
